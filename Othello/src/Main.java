...
public class Main {
    ...
    public Main() throws IOException {
        ...
        int choice = JOptionPane.showOptionDialog(null, "Make sure to install fonts " +
                        "located in the \"Othello\" folder \n" + "(Right click, choose 'Install for all users').\n",
        ...
        if (choice == 1) {
            ...
            mainHomePage.lbStartButton.addMouseListener(new MouseListener() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    mainGameProperPage.panelGameProper.setFocusable(true);
            ...
            System.exit(0); // if no choice is selected
        }
    }
